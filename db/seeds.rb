Post.destroy_all
p1 = Post.create(:topic => 'How do I javascript?', :content_md => 'How do I make a hello world in javascript?')
p2 = Post.create(:topic => 'What\'s Ruby?', :content_md => 'Is the language as precious as the gem?')
p3 = Post.create(:topic => 'This site is amazing!', :content_md => 'I want to have it\'s children')
